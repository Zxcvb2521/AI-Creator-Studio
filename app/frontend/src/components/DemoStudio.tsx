  ...
  return <div className="demo-studio">
    ...
    <div className="demo-body">
      <aside className="demo-sidebar">
        ...
        {['Deepy','Models','Settings'].map(x => <button key={x} className="demo-nav"><span>{x === 'Deepy' ? '◈' : x === 'Models' ? '◇' : '⚙'}</span>{x}{x === 'Deepy' && <em>AI</em>}</button>)}
